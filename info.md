...
проверять темплейты. первый дамон класс 1 явно не зашел. пробовать его руками - тут выясняется что интеjaw сеть выставлять не умеет. видимо особенност обучения. 
    - при этом точки предикта в пространстве головы выглядят сносно. 
делаем темплейты и насаживаем их на комбинации кнопок. 
что дальше????? показывать это как есть может вызвать вопросы 